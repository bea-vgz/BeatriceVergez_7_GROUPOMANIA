    ...
    <div class="fixed inset-0 transition-opacity">
      <form @submit.prevent="update" class="modifyProfil" v-if="currentUser">
        ...
        <b-form class="align-items-center">
          ...
          <div v-if="currentUser.isAdmin" class="d-flex align-items-center justify-content-center">
            <b-col sm="2" class="d-none d-lg-block p-0">
        ...
        <button
          type="submit"
          class="save-btn d-lg-block align-items-center justify-content-center" 
